...
public class AuthUiActivity_ViewBinding implements Unbinder {
  ...
  public AuthUiActivity_ViewBinding(final AuthUiActivity target, View source) {
    ...
    View view;
    view = Utils.findRequiredView(source, R.id.default_theme, "field 'mUseDefaultTheme' and method 'toggleDarkTheme'");
    target.mUseDefaultTheme = Utils.castView(view, R.id.default_theme, "field 'mUseDefaultTheme'", RadioButton.class);
    view2131230805 = view;
    view.setOnClickListener(new DebouncingOnClickListener() {
      @Override
      public void doClick(View p0) {
        target.toggleDarkTheme();
      }
    });
    view = Utils.findRequiredView(source, R.id.green_theme, "field 'mUseGreenTheme' and method 'toggleDarkTheme'");
    target.mUseGreenTheme = Utils.castView(view, R.id.green_theme, "field 'mUseGreenTheme'", RadioButton.class);
    view2131230855 = view;
    view.setOnClickListener(new DebouncingOnClickListener() {
      @Override
      public void doClick(View p0) {
    ...
    view = Utils.findRequiredView(source, R.id.purple_theme, "field 'mUsePurpleTheme' and method 'toggleDarkTheme'");
    target.mUsePurpleTheme = Utils.castView(view, R.id.purple_theme, "field 'mUsePurpleTheme'", RadioButton.class);
    view2131230931 = view;
    view.setOnClickListener(new DebouncingOnClickListener() {
      @Override
      public void doClick(View p0) {
    ...
    view = Utils.findRequiredView(source, R.id.dark_theme, "field 'mUseDarkTheme' and method 'toggleDarkTheme'");
    target.mUseDarkTheme = Utils.castView(view, R.id.dark_theme, "field 'mUseDarkTheme'", RadioButton.class);
    view2131230802 = view;
    view.setOnClickListener(new DebouncingOnClickListener() {
      @Override
      public void doClick(View p0) {
